...
@ManagedBean(name = "BarChartMas")
@ApplicationScoped
public class BarChartMas {
    ...
    public void graficar() {
        ...
        try {
            ...
            String sqlOption = "select nombreproducto, stock from productos order by stock desc LIMIT 3";
        ...
        barChartModel.setTitle("Productos mas Stock");
